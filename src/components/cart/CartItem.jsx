    ...
    return (
        <div className='cart-item flex justify-start my-1 border rounded mx-2 border-gray-200 p-1'>
            ...
            <div className='w-full'>
                <div className='mx-2'>
                    <h6>{title}</h6>
                    <h6 className='text-red-600 font-bold'>{price}</h6>
                </div>
                <div className='flex justify-between mt-2 w-full '>
                    <div className='bg-red-600 rounded flex w-fit px-3 py-1 mx-3 '>
                        <CustomQtnButton icon={<TiPlus color='white' />} />
                        <input className='w-10 text-center text-white' readOnly value='1' />
